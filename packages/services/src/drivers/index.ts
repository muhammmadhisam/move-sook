  ...
  const created = await prisma.$transaction(async (tx) => {
    ...
    const d = await tx.driver.create({
      data: {
        ...
        vehiclePhotoFront: input.vehiclePhotoFront ?? null,
        vehiclePhotoBack: input.vehiclePhotoBack ?? null,
        vehiclePhotoLeft: input.vehiclePhotoLeft ?? null,
        vehiclePhotoRight: input.vehiclePhotoRight ?? null,
        vehiclePhotoPlate: input.vehiclePhotoPlate ?? null,
...
export async function updateMyDriver(
  ...
  const updated = await prisma.driver.update({
    ...
    data: {
      ...
      ...(input.vehiclePhotoFront !== undefined ? { vehiclePhotoFront: input.vehiclePhotoFront } : {}),
      ...(input.vehiclePhotoBack !== undefined ? { vehiclePhotoBack: input.vehiclePhotoBack } : {}),
      ...(input.vehiclePhotoLeft !== undefined ? { vehiclePhotoLeft: input.vehiclePhotoLeft } : {}),
      ...(input.vehiclePhotoRight !== undefined ? { vehiclePhotoRight: input.vehiclePhotoRight } : {}),
      ...(input.vehiclePhotoPlate !== undefined ? { vehiclePhotoPlate: input.vehiclePhotoPlate } : {}),
